...
export const JiraTasks = ({ title, status, tasks }: Props) => {
  ...
  return (
    <div
      // cuando yo presiono el elemento y lo muevo dentro de si mismo 
      onDragOver={handleDragOver}
      onDragLeave={handleDragLeave}
      //cuando lo suelto sobre otro div
      onDrop={handleDrop}
      className={
        classNames("!text-black border-4 relative flex flex-col rounded-[20px]  bg-white bg-clip-border shadow-3xl shadow-shadow-500  w-full !p-4 3xl:p-![18px]", {
          'border-blue-500 border-dotted': isDraggind,
          'border-green-500 border-dotted': isDraggind && onDragOver,
        })
      }
    >
      ...
      <div className="h-full w-full">
        ...
        {
          !tasks.length && <p><strong>No hay tareas</strong></p>
        }
